...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MN Browsing Coin Core"),
     ...
     * override -datadir in the mnbrowsingcoin.conf file in the default data directory
     * (to be consistent with mnbrowsingcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
