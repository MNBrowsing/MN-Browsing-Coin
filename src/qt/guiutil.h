...
/** Utility functions used by the MN Browsing Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render MN Browsing Coin addresses in monospace font
...
// Parse "mnbrowsingcoin:" URI into recipient object, return true on successful parsing
