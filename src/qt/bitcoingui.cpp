                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MN Browsing Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MN Browsing Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mnbrowsingcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MN Browsing Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MN Browsing Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MN Browsing Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MN Browsing Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MN Browsing Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MN Browsing Coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MN Browsing Coin Core help message to get a list with possible MN Browsing Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MN Browsing Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MN Browsing Coin network", "", count));
}
...
{
    QString strTitle = tr("MN Browsing Coin Core"); // default title
    ...
    // Append title to "MN Browsing Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
