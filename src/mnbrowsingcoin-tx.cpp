...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MN Browsing Coin Core mnbrowsingcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnbrowsingcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnbrowsingcoin transaction") + "\n" +
                               "  mnbrowsingcoin-tx [options] -create [commands]   " + _("Create hex-encoded mnbrowsingcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnbrowsingcoin transaction
