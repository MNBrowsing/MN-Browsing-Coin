...
#if defined(NDEBUG)
#error "MN Browsing Coin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight <= 12000 && nHeight > 0) {
	nSubsidy = 1 * COIN;	
    } else if (nHeight <= 20000 && nHeight > 12000) {
    nSubsidy = 2 * COIN;
	...
	nSubsidy = 15 * COIN;	
	} else if (nHeight <= 150000 && nHeight > 85000) {
	nSubsidy = 5 * COIN;	
    ...
    if (nMoneySupply + nSubsidy >= 4000000 * COIN)
        nSubsidy = 30000000 - nMoneySupply;

    if (nMoneySupply >= 4000000 * COIN)
	nSubsidy = 0;
...
{
    RenameThread("mnbrowsingcoin-scriptch");
