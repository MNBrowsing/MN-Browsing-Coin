...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MN Browsing Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MN Browsing Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MN Browsing Coin features */
        {"mnbrowsingcoin", "masternode", &masternode, true, true, false},
        {"mnbrowsingcoin", "masternodelist", &masternodelist, true, true, false},
        {"mnbrowsingcoin", "mnbudget", &mnbudget, true, true, false},
        {"mnbrowsingcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"mnbrowsingcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mnbrowsingcoin", "mnsync", &mnsync, true, true, false},
        {"mnbrowsingcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"mnbrowsingcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mnbrowsingcoind, or the -server option to mnbrowsingcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mnbrowsingcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:57811/\n";
}
