...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("MN Browsing Coin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  mnbrowsingcoin-cli [options] <command> [params]  " + _("Send command to MN Browsing Coin Core") + "\n" +
                        "  mnbrowsingcoin-cli [options] help                " + _("List commands") + "\n" +
                        "  mnbrowsingcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
