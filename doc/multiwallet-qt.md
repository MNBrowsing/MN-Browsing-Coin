...
In order to support loading of multiple wallets in mnbrowsingcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mnbrowsingcoin.cpp.
...
Changes to mnbrowsingcoin.cpp
----------------------
mnbrowsingcoin.cpp is the entry point into mnbrowsingcoin-qt, and as such, will require some minor modifications to provide hooks for
