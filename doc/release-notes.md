MN Browsing Coin Core version 2.2.1 is now available from:

  <https://github.com/mnbrowsingcoin-project/mnbrowsingcoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/mnbrowsingcoin-project/mnbrowsingcoin/issues>

Compatibility
==============

MN Browsing Coin Core is extensively tested on multiple operating systems using
...
MN Browsing Coin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that MN Browsing Coin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/mnbrowsingcoin-project-translations/).
