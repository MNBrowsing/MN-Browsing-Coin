...
MN Browsing Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mnbrowsingcoin_address\> \<monthly_payment_mnbrowsingcoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MN Browsing Coin, _12_ times over the course of a year totaling _24000_ MN Browsing Coin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mnbrowsingcoin_address\> \<monthly_payment_mnbrowsingcoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` MN Browsing Coin.
 ...
 * vote-many          - Vote on a MN Browsing Coin initiative
 * vote-alias         - Vote on a MN Browsing Coin initiative
 * vote               - Vote on a MN Browsing Coin initiative/budget
