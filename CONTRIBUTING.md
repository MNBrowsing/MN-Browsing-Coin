Contributing to MN Browsing Coin Core
============================

The MN Browsing Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MN Browsing Coin Core project, and is not to be
confused with overall MN Browsing Coin Network Protocol consensus changes.

Whether a pull request is merged into MN Browsing Coin Core rests with the project merge
...
Patches that change MN Browsing Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MN Browsing Coin consensus, it must have been
...
The project leader is the release manager for each MN Browsing Coin Core release.
